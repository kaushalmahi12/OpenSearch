...
public class CreateQueryGroupRequestTests extends OpenSearchTestCase {
    ...
    public void testInvalidName() {
        assertThrows(
            ...
            () -> new CreateQueryGroupRequest("", _ID_ONE, ResiliencyMode.MONITOR, Map.of("jvm", 0.3), TIMESTAMP_ONE)
        );
        assertThrows(
            IllegalArgumentException.class,
            () -> new CreateQueryGroupRequest("-test", _ID_ONE, ResiliencyMode.MONITOR, Map.of("jvm", 0.3), TIMESTAMP_ONE)
        );
        assertThrows(
            IllegalArgumentException.class,
            () -> new CreateQueryGroupRequest(":test", _ID_ONE, ResiliencyMode.MONITOR, Map.of("jvm", 0.3), TIMESTAMP_ONE)
    ...
    public void testInvalidResourceLimitList() {
        assertThrows(
            IllegalArgumentException.class,
            () -> new CreateQueryGroupRequest(NAME_ONE, _ID_ONE, ResiliencyMode.MONITOR, new HashMap<>(), TIMESTAMP_ONE)
        );
        ...
        assertThrows(
            IllegalArgumentException.class,
            () -> new CreateQueryGroupRequest(NAME_ONE, _ID_ONE, ResiliencyMode.MONITOR, Map.of("jvm", -0.3), TIMESTAMP_ONE)
        );

        assertThrows(
            IllegalArgumentException.class,
            () -> new CreateQueryGroupRequest(NAME_ONE, _ID_ONE, ResiliencyMode.MONITOR, Map.of("jvm", 12.0), TIMESTAMP_ONE)
        );

        assertThrows(
            IllegalArgumentException.class,
            () -> new CreateQueryGroupRequest(NAME_ONE, _ID_ONE, ResiliencyMode.MONITOR, Map.of("cpu", 0.3), TIMESTAMP_ONE)
        );
    }
    ...
    public void testInvalidEnforcement() {
        assertThrows(
            IllegalArgumentException.class,
            () -> new CreateQueryGroupRequest(NAME_ONE, _ID_ONE, ResiliencyMode.fromName("random"), Map.of("jvm", 0.3), TIMESTAMP_ONE)
        );
    }
}
