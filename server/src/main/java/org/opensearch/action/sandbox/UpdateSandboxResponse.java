...
/**
 * Response object for the UpdateSandbox action
 */
public class UpdateSandboxResponse extends ActionResponse implements ToXContent, StatusToXContentObject {
    ...
    public UpdateSandboxResponse(final Sandbox sandbox) {
